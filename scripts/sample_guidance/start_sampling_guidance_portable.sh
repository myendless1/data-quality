...
RIGHT_ARM_URDF="${RIGHT_ARM_URDF:-$SCRIPT_DIR/astribot_descriptions/urd 14:55 multidrop_episode_99.hdf5.review.pngf/astribot_s1_urdf/astribot_arm_right.urdf}"
